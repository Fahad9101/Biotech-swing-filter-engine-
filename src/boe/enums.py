...
class UniverseStatus(StrEnum):
    INCLUDED = "INCLUDED"
    SEPARATE_NON_RANKABLE = "SEPARATE_NON_RANKABLE"
    EXCLUDED = "EXCLUDED"
    WATCHLIST_UNIVERSE_REVIEW = "WATCHLIST_UNIVERSE_REVIEW"


class InvestabilityFloorStatus(StrEnum):
    NOT_EVALUATED = "NOT_EVALUATED"
    PASS = "PASS"
    FAIL = "FAIL"


class LeadEconomicAssetType(StrEnum):
    ...
    DIVERSIFIED_PHARMA = "DIVERSIFIED_PHARMA"
    NONE = "NONE"
    UNKNOWN = "UNKNOWN"
