...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint("evidence_id", "canonical_key", "source_statement", name="uq_catalyst_observation"),
    )
    ...
    op.create_table(
        ...
        sa.Column("window_end", sa.String(10), nullable=False),
        sa.Column("timing_confidence", sa.String(), nullable=False),
        sa.Column("primary_evidence_id", sa.String(36), sa.ForeignKey("evidence_items.id"), nullable=False),
    ...
    op.create_table(
        "catalyst_conflicts",
        sa.Column("id", sa.String(36), primary_key=True),
        sa.Column("catalyst_version_id", sa.String(36), sa.ForeignKey("catalyst_versions.id"), nullable=False),
    ...
    op.create_index("ix_catalyst_confirmations_version", "catalyst_confirmations", ["catalyst_version_id"])
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.String(40), nullable=False),
        sa.UniqueConstraint("catalyst_version_id", "evidence_cutoff", name="uq_scientific_pack_cutoff"),
    )
